...
namespace WebStateCenter.help
{
    class XmlHelper
    {
        ...
        internal static void Enity2Xml(string filePath, object sourceObj, Type type = null, string xmlRootName = null)
        {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        internal static object Xml2Entity(string filePath, Type type)
        {
            object result = null;
